    ...
    class Cheque {
        ...
        public Cheque(String cliente, double valorCheque, Banco banco) {
    ...
    public class TestEntidadFinanciera {
        public static void main(String[] args) {
            Cliente cliente= new Cliente("Carlos","Piedra","1150067906");
            Banco banco= new Banco("BancoGuayaquil",15);
            Cheque cheque=new Cheque("Cliente",20000,banco);
